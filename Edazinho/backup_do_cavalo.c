...
void sondar(edazin x, int *count, long int *count_coord_0, long int *count_coord_1, long int *count_coord_2, long int *count_coord_3){
    ...
    long int vet_possicoes_coluna[8] = {coluna, coluna-1, coluna+1,coluna-1, coluna+1, coluna, coluna+1, coluna-1};
    long int vet_possicoes_linha[8] = {linha-1, linha,    linha,   linha+1,   linha-1, linha+1, linha+1, linha-1};
