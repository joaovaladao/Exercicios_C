...
edazin dominar(edazin mais_baixo, edazin mais_alto, int tam_0, int tam_1, int tam_2, int tam_3){
...
int main() {
    ...
    for(contador_de_turnos = 1; contador_de_turnos <= turnos; contador_de_turnos++){
        ...
        if(contador_de_turnos == 1){
            ...
            int printa_domina = 0;
            edazin dummy = dominar(mais_baixo, mais_alto, count_coord_0, count_coord_1, count_coord_2, count_coord_3);
